...
@Mod(modid = ShadowMurderMysteryMod.MODID, version = ShadowMurderMysteryMod.VERSION)
public class ShadowMurderMysteryMod
{
	...
	public static final String MODID = "shadowmurdermysterymod";
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        solver = new KeyBinding("Toggle MurderMysterySolver", Keyboard.KEY_M, "Shadow Murder Mystery Solver Mod");
    ...
    public void onKey(KeyInputEvent event)
    {
    	if(solver.isPressed())
    	{
        	...
        	Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.BLUE + "Murder Mystery Solver has been set to " + EnumChatFormatting.AQUA + toggled));
    	}
    }
